...
1. Open prompt_engineering.py file, and replace the following values with your OpenAI model values in the application.
        (your_azure_oai_endpoint)
        (your_azure_oai_key)
        (your_azure_oai_deployment)

2.After making the changes, save the prompt_engineering.py file.

## Run your application


1. In the interactive terminal pane, ensure that all your lab dependent files available. Then enter the following command to run the application.

    -Install the OpenAI package:
    'pip install openai==1.13.3'
    - To run the appication enter the following to run your application: `python prompt_engineering.py`

   

2. Enter the following prompts (with the **system message** still being entered and saved in `system.txt`).
